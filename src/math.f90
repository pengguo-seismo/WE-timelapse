...
interface min_value
  ...
  module procedure min_value_3d
  module procedure min_value_3d_topo
end interface
...
!------------------------------------------------------------------------------
function max_value_3d(x, n1, n2, n3)

integer, intent(in) :: n1, n2, n3
real, intent(in)    :: x(:,:,:)
integer             :: i, j, k
real                :: max_value_3d, temp
...
!------------------------------------------------------------------------------
function min_value_3d(x, n1, n2, n3)
...
min_value_3d = 10000000000.0

do i=1,n1
  do j=1,n2
    do k=1,n3
      if (min_value_3d > x(i,j,k)) then
        min_value_3d = x(i,j,k)
      endif
    enddo
  enddo
enddo

end function min_value_3d

!------------------------------------------------------------------------------
function min_value_3d_topo(x, n1, n2, n3, fs)

integer, intent(in) :: n1, n2, n3, fs(:,:)
real, intent(in)    :: x(:,:,:)
integer             :: i, j, k
real                :: min_value_3d_topo

min_value_3d_topo = 10000000000.0

do i=1,n1
  do j=1,n2
    do k=1,n3
      if (i > fs(j,k)) then
        if (min_value_3d_topo > x(i,j,k)) then
          min_value_3d_topo = x(i,j,k)
        endif
      endif
    enddo
  enddo
...
end function min_value_3d_topo

!------------------------------------------------------------------------------
function cmax_abs(x, n)
...
do i=1,n
  if (cmax_abs < abs(x(i))) then
    cmax_abs = abs(x(i))
  endif
enddo

end function cmax_abs
...
!------------------------------------------------------------------------------
function mean_abs_3d(A, n1, n2, n3)
...
do iy=1,n2
do iz=1,n1
    mean_abs_3d=mean_abs_3d+abs(A(iz,iy,ix))
enddo
enddo
enddo
mean_abs_3d = mean_abs_3d/real(n1*n2*n3)

end function mean_abs_3d
