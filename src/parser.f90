...
! use interface such that several functions/subroutines with different input 
...
subroutine readParFileString(filename, keyword, cvalue, default, required)
  ...
  print *, 'readParFileString  ', trim(cvalue) 
